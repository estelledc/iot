...
class RepositoryCorpusTests(unittest.TestCase):
    def test_repository_enumeration_and_body_manifest_are_stable(self) -> None:
        ...
        self.assertEqual(697, len(first))
        self.assertEqual(697, len({document.content_id for document in first}))
        ...
        for document in first:
            ...
            manifest.update(b"\0")
        self.assertEqual(
            "8abfa73e8b532248f1d39f476020a10a7a1f7aecadcab34edf27597bf769381b",
            manifest.hexdigest(),
        )
