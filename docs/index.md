...
<section class="iot-hero" aria-labelledby="iot-title">
  <div class="iot-hero__copy">
    ...
    <div class="iot-hero__status">
      ...
      <span><b>642 / 697</b> HUMAN_APPROVED</span>
      <span><b>642 / 697</b> SOURCE VERIFIED</span>
    </div>
    <h1 id="iot-title">先看依赖，再选择要深入的 IoT 层。</h1>
    <p class="iot-hero__lead">
      这不是 697 篇文章的陈列柜，而是一张可进入、可检查的系统地图。每层同时公开内容规模、上游依赖和审查状态；新增 55 篇保持 <code>UNVERIFIED</code> / <code>UNREVIEWED</code>，旧版 <code>NOT_TRACKED</code> 风险标签也会留在首屏，不被“内容很多”掩盖。
    </p>
  ...
  <aside class="iot-stack-lab" aria-labelledby="stack-lab-title">
    ...
    <ol class="iot-stack-map">
      <li><a href="frontier/"><span class="iot-stack-map__id">L8</span><strong>前沿方向</strong><small>33 files</small><em>MIXED</em><b>8 UNVERIFIED</b></a></li>
      <li><a href="applications/"><span class="iot-stack-map__id">L7</span><strong>综合应用</strong><small>34 files · depends on L4–L6</small><em>MIXED</em><b>9 UNVERIFIED</b></a></li>
      <li><a href="security/"><span class="iot-stack-map__id">L6</span><strong>安全与隐私</strong><small>36 files · cross-cutting</small><em>MIXED</em><b>11 UNVERIFIED</b></a></li>
      <li><a href="intelligence/"><span class="iot-stack-map__id">L5</span><strong>边缘智能</strong><small>42 files · depends on L4</small><em>MIXED</em><b>17 UNVERIFIED</b></a></li>
      <li><a href="computing/"><span class="iot-stack-map__id">L4</span><strong>计算平台</strong><small>29 files · depends on L1–L3</small><em>MIXED</em><b>4 UNVERIFIED</b></a></li>
      <li><a href="network/"><span class="iot-stack-map__id">L3</span><strong>网络协议</strong><small>29 files · depends on L2</small><em>MIXED</em><b>4 UNVERIFIED</b></a></li>
  ...
  <div class="jx-proof">
    <div>
      ...
      <div class="jx-proof__metrics" aria-label="可机械验证的项目证据">
        ...
        <div class="jx-proof__metric"><strong>697</strong><span>个内容文件，全部可发现</span></div>
    ...
    <dl class="jx-proof__meta">
      ...
      <div><dt>Evidence / 证据</dt><dd>697 个文件全部进入可发现目录；642/697 正文已有 <code>VERIFIED</code> / <code>HUMAN_APPROVED</code> 投影，新增 55 篇保持初读状态。</dd></div>
...
<section class="iot-stats" aria-label="内容基线">
  ...
  <div class="iot-stats__item">
    <span class="iot-stats__num">697</span>
...
| Layer 3 | [网络协议](network/index.md) | 29 |
| Layer 4 | [计算平台](computing/index.md) | 29 |
| Layer 5 | [边缘智能](intelligence/index.md) | 42 |
| Layer 6 | [安全与隐私](security/index.md) | 36 |
| Layer 7 | [综合应用](applications/index.md) | 34 |
| Layer 8 | [前沿方向](frontier/index.md) | 33 |
| **合计** | | **697** |
