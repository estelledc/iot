...
| Layer 5 | 边缘智能 | 31 | 25 | 31 | 31 | 15 | 301 | 326 |
| Layer 6 | 安全与隐私 | 26 | 25 | 26 | 26 | 10 | 197 | 222 |
| Layer 7 | 综合应用 | 26 | 25 | 26 | 26 | 10 | 205 | 230 |
| Layer 8 | 前沿方向 | 25 | 25 | 25 | 25 | 10 | 248 | 273 |
| **合计** | | **652** | **200** | **652** | **652** | **85** | **1761** | **1964** |

- **内容文件 652**：可被 MkDocs 构建，不等于已完成来源审计。
- **显式导航 200**：当前 `mkdocs.yml` 直接列出的内容文件。
- **目录页入口 652**：八个层级 `catalog.md` 直接链接的内容文件。
- **可发现 652**：显式导航 ∪ 目录页链接。
- **层级首页入口 85**：八个概览页直接链接的内容文件。
