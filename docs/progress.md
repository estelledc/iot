...
| Layer 5 | 边缘智能 | 34 | 25 | 34 | 34 | 18 | 301 | 326 |
| Layer 6 | 安全与隐私 | 28 | 25 | 28 | 28 | 12 | 197 | 222 |
| Layer 7 | 综合应用 | 26 | 25 | 26 | 26 | 10 | 205 | 230 |
| Layer 8 | 前沿方向 | 25 | 25 | 25 | 25 | 10 | 248 | 273 |
| **合计** | | **657** | **200** | **657** | **657** | **90** | **1761** | **1964** |

- **内容文件 657**：可被 MkDocs 构建，不等于已完成来源审计。
- **显式导航 200**：当前 `mkdocs.yml` 直接列出的内容文件。
- **目录页入口 657**：八个层级 `catalog.md` 直接链接的内容文件。
- **可发现 657**：显式导航 ∪ 目录页链接。
